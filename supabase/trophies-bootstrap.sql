-- Run in Supabase → SQL Editor if `public.trophies` does not exist yet
-- (equivalent to applying migration 20260422120000_trophies.sql)

-- 1) Notifications: allow type 'trophy'
