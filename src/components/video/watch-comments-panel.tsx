    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-1.5 sm:gap-4 lg:grid-cols-[1fr_380px_84px]">
        ...
        <aside className="relative">
          <div className="-ml-5 -mr-3 flex flex-col overflow-hidden sm:ml-0 sm:mr-0 lg:absolute lg:inset-0 lg:rounded-xl lg:border lg:border-white/[0.06] lg:bg-white/[0.01]">
            <WatchMetaSidebar
              videoId={videoId}
              video={video}
              creatorId={creatorId}
        ...
        <aside className="relative">
          <div className="-ml-5 -mr-3 mt-1 flex flex-col gap-1.5 overflow-x-hidden border-t border-white/[0.08] pt-3 sm:ml-0 sm:mr-0 sm:mt-0 sm:border-0 sm:pt-0 lg:absolute lg:inset-0 lg:overflow-y-auto">
            {upNextSlot}
          </div>
        </aside>
      </div>
