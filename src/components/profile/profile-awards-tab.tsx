    ...
    <section className="space-y-10" aria-labelledby="awards-tab-heading">
      ...
      <div className="space-y-3">
        <div className="flex flex-col gap-1 border-b border-white/10 pb-2">
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#7F77DD]">Recorded awards</p>
          <p className="text-sm text-[#AFA9EC]">Award history linked to your profile (user_awards)</p>
        </div>
        {awards.length === 0 ? (
          <div className="rounded-xl border border-dashed border-white/15 bg-[#1A1535]/60 px-6 py-10 text-center">
            <p className="text-sm text-[#F8F7FF]">No recorded awards yet.</p>
            <p className="mt-2 text-sm text-[#AFA9EC]">
              Enter a competition to win your first award — results will show here when added.
            </p>
            <Link
              href="/competition"
