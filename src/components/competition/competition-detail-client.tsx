...
export function CompetitionDetailClient({
  ...
  return (
    <div className="relative min-h-screen text-white">
      ...
      {/* ── Tab Content ──────────────────────────── */}
      <div className="relative z-10 mx-auto min-h-[58vh] w-full space-y-20 px-4 py-12 md:px-8">

        {/* 개요 */}
        <section id="overview" className={cn("mx-auto w-full max-w-[1400px]", section === "overview" ? "block" : "hidden")}>
        ...
        {/* 심사 및 시상 */}
        <section id="judging" className={cn("mx-auto w-full max-w-[1400px]", section === "judging" ? "block" : "hidden")}>
        ...
        {/* 문의 */}
        <section id="faq" className={cn("mx-auto w-full max-w-[1400px]", section === "faq" ? "block" : "hidden")}>
        ...
        {/* 출품작 */}
        <section id="entries" className={cn("mx-auto w-full max-w-[1920px]", section === "entries" ? "block" : "hidden")}>
