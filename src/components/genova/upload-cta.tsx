...
export function UploadCTA() {
  return (
    <section className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#080618]/40 px-8 py-10 backdrop-blur-xl transition-colors duration-200 hover:border-white/15 sm:px-12 sm:py-12">
