...
export function CompetitionBanner({ deadlineIso }: { deadlineIso: string | null }) {
  ...
  return (
    <div
      className="relative overflow-hidden rounded-xl border border-[rgba(139,92,246,0.2)]"
      style={{
        background: "linear-gradient(135deg, #1a1535 0%, #1e1a3e 40%, #251d4a 70%, #1a1535 100%)",
      }}
    >
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background: "radial-gradient(ellipse 40% 80% at 0% 50%, rgba(139,92,246,0.15) 0%, transparent 60%)",
        }}
      />
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="min-w-0 flex items-center gap-3">
            ...
            <div className="min-w-0">
              <h2 className="text-lg font-bold text-white">{t("banner.title", "Genova AI Film Contest 2026")}</h2>
