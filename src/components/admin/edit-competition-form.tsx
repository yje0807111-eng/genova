  ...
  return (
    ...
    >
      <div className="mb-4 flex items-baseline gap-2.5 border-b border-white/[0.05] pb-3">
        <span className="flex h-6 w-6 shrink-0 items-center justify-center self-center rounded-full bg-[#534AB7]/25 text-[11px] font-black text-[#AFA9EC]">
          {step}
        </span>
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pb-8">
      ...
      <form onSubmit={(e) => void submit(e)} className="space-y-4">
        {/* 상단 고정 바 — 언어 전환은 항상 접근 가능 */}
        <div
          className="sticky top-0 z-20 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/[0.08] px-5 py-3 backdrop-blur-xl"
        ...
        {/* ① 기본 정보 */}
        <Section step={1} title="기본 정보" hint="제목·소개·분류">
        ...
        {/* ② 일정 */}
        <Section step={2} title="일정" hint="접수·투표 기간">
        ...
        {/* ③ 상금 · 환율 */}
        <Section step={3} title="상금 · 환율" hint="총 상금·환산·배분">
        ...
        {/* ④ 규칙 · 심사 */}
        <Section step={4} title="규칙 · 심사" hint={langSuffix}>
          <EditCompetitionRulesFields form={form} setForm={setForm} langTab={langTab} />
        </Section>

        {/* ⑤ 미디어 */}
        <Section step={5} title="미디어" hint="썸네일·스폰서 로고">
        ...
        {/* ⑥ 공지 */}
        <Section step={6} title="공지 · 템플릿" hint={langSuffix}>
          <div className="space-y-3">
            <div>
        ...
        {/* 하단 고정 저장 바 */}
        <div
          className="sticky bottom-0 z-20 flex items-center justify-end gap-3 rounded-2xl border border-white/[0.08] px-5 py-3 backdrop-blur-xl"
          style={{ background: "rgba(12,9,28,0.85)" }}
        >
          {message && (
